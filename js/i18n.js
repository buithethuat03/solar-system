...
const STRINGS = {
  en: {
    ...
    offlineDownload: 'Download (~{mb} MB)',
    offlineProgress: '{done}/{total} files…',
    offlineDone: 'Ready for offline use ✓',
    offlineFail: 'Download failed — check the connection',
    offlineUnsupported: 'Needs HTTPS (or localhost) to enable',
  ...
  vi: {
    ...
    offlinePack: 'Gói ngoại tuyến',
    offlineDownload: 'Tải về (~{mb} MB)',
    offlineProgress: '{done}/{total} tệp…',
    offlineDone: 'Sẵn sàng dùng ngoại tuyến ✓',
    offlineFail: 'Tải lỗi — kiểm tra kết nối',
    offlineUnsupported: 'Cần HTTPS (hoặc localhost) để bật',
